...
#ifndef BEJWRMCZXMS9NLS5OTE8FABVBAR4_H_
#define BEJWRMCZXMS9NLS5OTE8FABVBAR4_H_
...
#define SELF BeJwrMczxMs9NLS5OTE8FABvbAR4
...
public:
    ...
    typedef SPL::list<SPL::uint8 > message_type;

    enum { num_attributes = 1 } ;
    
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), message_(ot.message_) 
      { constructPayload(ot); }
    SELF(const message_type & _message) : Tuple(), message_(_message) { }
...
#undef SELF
#endif // BEJWRMCZXMS9NLS5OTE8FABVBAR4_H_ 
