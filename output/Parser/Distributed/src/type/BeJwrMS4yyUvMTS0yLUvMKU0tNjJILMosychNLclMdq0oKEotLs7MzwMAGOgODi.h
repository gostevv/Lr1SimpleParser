// t3r4namer5values20arithmeticExpression


#ifndef BEJWRMS4YYUVMTS0YLUVMKU0TNJJILMOSYCHNLCLMDQ0OKEOTLS7MZWMAGOGODI_H_
#define BEJWRMS4YYUVMTS0YLUVMKU0TNJJILMOSYCHNLCLMDQ0OKEOTLS7MZWMAGOGODI_H_
...
#define SELF BeJwrMS4yyUvMTS0yLUvMKU0tNjJILMosychNLclMdq0oKEotLs7MzwMAGOgODi
...
public:
    ...
    typedef SPL::ustring value_type;
    typedef SPL::rstring arithmeticExpression_type;

    enum { num_attributes = 3 } ;
    
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), name_(ot.name_), value_(ot.value_), arithmeticExpression_(ot.arithmeticExpression_) 
      { constructPayload(ot); }
    SELF(const name_type & _name, const value_type & _value, const arithmeticExpression_type & _arithmeticExpression) : Tuple(), name_(_name), value_(_value), arithmeticExpression_(_arithmeticExpression) { }
    ...
    arithmeticExpression_type & get_arithmeticExpression() { return arithmeticExpression_; }
    const arithmeticExpression_type & get_arithmeticExpression() const { return arithmeticExpression_; }
    void set_arithmeticExpression(const arithmeticExpression_type & _arithmeticExpression) { arithmeticExpression_ = _arithmeticExpression; }
    ...
    {
        buf << name_ << value_ << arithmeticExpression_;
    }
    ...
    size_t hashCode() const
    {
        ...
        s = 37 * s + std::tr1::hash<arithmeticExpression_type >()(arithmeticExpression_);
        return s;
    }
   ...
   size += value_.getSerializedSize();
   size += arithmeticExpression_.getSerializedSize();
    ...
    { 
        name_ = ot.name_;
        value_ = ot.value_;
        arithmeticExpression_ = ot.arithmeticExpression_; 
        assignPayload(ot);
        return *this; 
    }
    ...
    { 
        ...
        std::swap(arithmeticExpression_, ot.arithmeticExpression_);
...
private:
    ...
    name_type name_;
    value_type value_;
    arithmeticExpression_type arithmeticExpression_;
...
#undef SELF
#endif // BEJWRMS4YYUVMTS0YLUVMKU0TNJJILMOSYCHNLCLMDQ0OKEOTLS7MZWMAGOGODI_H_ 
