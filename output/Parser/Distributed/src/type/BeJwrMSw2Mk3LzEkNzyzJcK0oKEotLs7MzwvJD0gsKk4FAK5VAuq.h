// t1s25fileWithExpressionToParse


#ifndef BEJWRMSW2MK3LZEKNZYZJCK0OKEOTLS7MZWVJD0GSKK4FAK5VAUQ_H_
#define BEJWRMSW2MK3LZEKNZYZJCK0OKEOTLS7MZWVJD0GSKK4FAK5VAUQ_H_
...
#define SELF BeJwrMSw2Mk3LzEkNzyzJcK0oKEotLs7MzwvJD0gsKk4FAK5VAuq
...
public:
    ...
    typedef SPL::rstring fileWithExpressionToParse_type;

    enum { num_attributes = 1 } ;
    
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), fileWithExpressionToParse_(ot.fileWithExpressionToParse_) 
      { constructPayload(ot); }
    SELF(const fileWithExpressionToParse_type & _fileWithExpressionToParse) : Tuple(), fileWithExpressionToParse_(_fileWithExpressionToParse) { }
    ...
    fileWithExpressionToParse_type & get_fileWithExpressionToParse() { return fileWithExpressionToParse_; }
    const fileWithExpressionToParse_type & get_fileWithExpressionToParse() const { return fileWithExpressionToParse_; }
    void set_fileWithExpressionToParse(const fileWithExpressionToParse_type & _fileWithExpressionToParse) { fileWithExpressionToParse_ = _fileWithExpressionToParse; }
    ...
    {
        buf << fileWithExpressionToParse_;
    }
    ...
    {
        size_t s = 17;
        s = 37 * s + std::tr1::hash<fileWithExpressionToParse_type >()(fileWithExpressionToParse_);
        return s;
    }
    ...
    {
        size_t size = 0;
           size += fileWithExpressionToParse_.getSerializedSize();
    ...
    { 
        fileWithExpressionToParse_ = ot.fileWithExpressionToParse_; 
        assignPayload(ot);
        return *this; 
    }
    ...
    void swap(SELF & ot) 
    { 
        std::swap(fileWithExpressionToParse_, ot.fileWithExpressionToParse_);
...
private:
    ...
    fileWithExpressionToParse_type fileWithExpressionToParse_;
...
#undef SELF
#endif // BEJWRMSW2MK3LZEKNZYZJCK0OKEOTLS7MZWVJD0GSKK4FAK5VAUQ_H_ 
