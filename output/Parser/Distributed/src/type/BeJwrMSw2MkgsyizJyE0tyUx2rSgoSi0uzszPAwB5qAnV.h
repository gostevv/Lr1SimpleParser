// t1s20arithmeticExpression


#ifndef BEJWRMSW2MKGSYIZJYE0TYUX2RSGOSI0UZSZPAWB5QANV_H_
#define BEJWRMSW2MKGSYIZJYE0TYUX2RSGOSI0UZSZPAWB5QANV_H_
...
#define SELF BeJwrMSw2MkgsyizJyE0tyUx2rSgoSi0uzszPAwB5qAnV
...
public:
    ...
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), arithmeticExpression_(ot.arithmeticExpression_) 
      { constructPayload(ot); }
    SELF(const arithmeticExpression_type & _arithmeticExpression) : Tuple(), arithmeticExpression_(_arithmeticExpression) { }
...
#undef SELF
#endif // BEJWRMSW2MKGSYIZJYE0TYUX2RSGOSI0UZSZPAWB5QANV_H_ 
