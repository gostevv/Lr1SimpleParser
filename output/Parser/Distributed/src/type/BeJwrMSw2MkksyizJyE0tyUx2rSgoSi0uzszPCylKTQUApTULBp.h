// t1s24arithmeticExpressionTree


#ifndef BEJWRMSW2MKKSYIZJYE0TYUX2RSGOSI0UZSZPCYLKTQUAPTULBP_H_
#define BEJWRMSW2MKKSYIZJYE0TYUX2RSGOSI0UZSZPCYLKTQUAPTULBP_H_
...
#define SELF BeJwrMSw2MkksyizJyE0tyUx2rSgoSi0uzszPCylKTQUApTULBp
...
public:
    ...
    typedef SPL::rstring arithmeticExpressionTree_type;

    enum { num_attributes = 1 } ;
    
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), arithmeticExpressionTree_(ot.arithmeticExpressionTree_) 
      { constructPayload(ot); }
    SELF(const arithmeticExpressionTree_type & _arithmeticExpressionTree) : Tuple(), arithmeticExpressionTree_(_arithmeticExpressionTree) { }
    ...
    arithmeticExpressionTree_type & get_arithmeticExpressionTree() { return arithmeticExpressionTree_; }
    const arithmeticExpressionTree_type & get_arithmeticExpressionTree() const { return arithmeticExpressionTree_; }
    void set_arithmeticExpressionTree(const arithmeticExpressionTree_type & _arithmeticExpressionTree) { arithmeticExpressionTree_ = _arithmeticExpressionTree; }
    ...
    {
        size_t s = 17;
        s = 37 * s + std::tr1::hash<arithmeticExpressionTree_type >()(arithmeticExpressionTree_);
        return s;
    }
    ...
    {
        size_t size = 0;
           size += arithmeticExpressionTree_.getSerializedSize();
    ...
    { 
        arithmeticExpressionTree_ = ot.arithmeticExpressionTree_; 
        assignPayload(ot);
        return *this; 
    }
    ...
    void swap(SELF & ot) 
    { 
        std::swap(arithmeticExpressionTree_, ot.arithmeticExpressionTree_);
...
private:
    ...
    arithmeticExpressionTree_type arithmeticExpressionTree_;
...
#undef SELF
#endif // BEJWRMSW2MKKSYIZJYE0TYUX2RSGOSI0UZSZPCYLKTQUAPTULBP_H_ 
