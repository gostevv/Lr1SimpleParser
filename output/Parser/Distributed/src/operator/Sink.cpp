...
void MY_OPERATOR_SCOPE::MY_OPERATOR::process(Tuple const & tuple$, uint32_t port)
{
    ...
    try {
        ...
        SPL::serializeUnquoted(_f->writeTo(), iport$0.get_arithmeticExpressionTree()) << '\n';
...
MY_BASE_OPERATOR::MY_BASE_OPERATOR()
 : Operator() {
    ...
    param$closeMode$0 = "dynamic";
    addParameterValue ("closeMode", SPL::ConstValueHandle(param$closeMode$0));
